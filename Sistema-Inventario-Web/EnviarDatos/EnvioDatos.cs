...
{
   public  class EnvioDatos:DatosInventarios,IDisposable
    {
        protected DbContext Context;
        public EnvioDatos(DbContext context, bool autoDetectChangesEnabled = false, bool proxiCreationEnabled = false)
        {
